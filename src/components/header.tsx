      ...
      <div className="flex flex-col">
        ...
        {isOpen && (
          <ul className="absolute flex flex-col items-center top-0 p-5 pt-20 left-0 w-80 h-full z-50 bg-black opacity-90 shadow-lg text-white space-y-5 text-xl">
            <li>
              <NavLink to="/webshop-cupcakes/" onClick={toggleOpen} >Home</NavLink>
            </li>
            <li>
              <NavLink to="/webshop-cupcakes/products" onClick={toggleOpen}>Products</NavLink>
            </li>
            <li>
              <NavLink to="/webshop-cupcakes/about" onClick={toggleOpen}>About</NavLink>
            </li>
            <li>
              <NavLink to="/webshop-cupcakes/contact" onClick={toggleOpen}>Contact</NavLink>
            </li>
          </ul>
        )}
      </div>
